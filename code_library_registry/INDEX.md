...
| CLR-0031 | **MATHEMATICAL SUBSTRATE SYSTEM — CORE FORMULA EXERCISE PLATFORM** | Historical mathematical-carrier prototype / Assessed / Formula Registry reconstruction candidate | Very High — transfers carrier methodology from project glyphs to conventional math operators, decomposes Core Formula into executable components, and exposes recursive “fractal” transform as closed-form linear scaling; formal math semantics must remain authoritative over project substrate analogies |

| CLR-0032 | **CROSS-SUBSTRATE BRIDGE — MATHEMATICS SPEAKING THROUGH MASHET** | Historical cross-registry translation prototype / Assessed / High-priority reconstruction candidate | Very High — introduces explicit Math→Bridge→Glyph relations and directly anticipates the dual glyph/math curriculum; current mapping is declared rather than discovered, set-based translation loses operator order/topology, Core Formula anchor/feedback labels are unmapped, numeric state is unused, and generated strings are constructed Mashet sequences rather than validated Hebrew vocabulary |

| CLR-0033 | **MASHET SUBSTRATE PHYSICS KERNEL — PHASE 1** | Recovered executable physics-kernel prototype / Assessed / High-priority reconstruction candidate | Very High — 32×32×6 Bedrock field, explicit glyph field operators, 22-letter resonance registry, Indus positional patterns, Lipschitz guard and ARV broadcast engine; numerical behavior separated from authored semantic mappings |

| CLR-0034 | **MASHET ☉ 96-GLYPH R₀ PWA** | Recovered PWA/kernel-interface prototype / Assessed / Reconstruction candidate | Very High — formula + glyph lattice + R₀ registry axes + field canvas + chat/build workspace; direct Notebook/PWA ancestor, with random “coherence” metric and mutable untyped R₀ schema flagged |

| CLR-0035 | **DYNAMIC MATRIX ENGINE / OPERATIONAL-PRIMES DESIGN** | Recovered design/spec artifact / Assessed | Very High — develops 96-symbol operator vocabulary plus SPO, local/global, graph/Laplacian, memory, Echo and Lipschitz algebra; design lineage rather than blanket implementation claim |
| CLR-0036 | **MASHET · ALEMEKET · INDEPENDENT — 96-GLYPH ENGINE** | Recovered executable offline symbolic engine / Assessed / High-priority reconstruction candidate | Very High — 96 declared first-class fn(state)->delta operators, manifold/kernel/introspection/synthesis/IETF stack; duplicate Unicode key ⧫ causes one operator overwrite and motivates immutable symbol IDs |
| CLR-0037 | **MASHET SENTENCE ENGINE** | Recovered compositional language workbench / Assessed | Very High — Glyph→Word→Sentence editor with null operators, inversion, superposition, resonance and sentence analysis; direct Notebook language-tool ancestor |
| CLR-0038 | **IETF (0,0) SYNTHESIS PRIMITIVE** | Recovered coordinate-normalization experiment / Assessed / Reference | Medium — centroid recentering plus factorial contraction; useful canonicalization ancestor, not by itself semantic synthesis |
| CLR-0039 | **PRODUCTION FRACTALGRID WITH HIERARCHICAL INSTANCING** | Recovered fuller FractalGrid implementation / Assessed | High — reusable UnitTemplate/ElementalVault, cache, hierarchical environment instancing, validation/audit; energy/carbon figures are illustrative rather than measured |

| CLR-0040 | **MASHETEVE V3 — PERSISTENT GRAPH ENVIRONMENT** | Recovered executable EVE runtime / Assessed / High-priority reconstruction candidate | Very High — weighted substrate graph, persistent SQLite Da'ath deposits, semantic rays, layered boot and evolving traversal weights; authored coordinates/policy separated from behavioral evidence |
| CLR-0041 | **MASHET CENTRAL HUB V3** | Recovered offline Flask control center / Assessed | Very High Notebook/PWA relevance — local EVE bridge, status/process endpoints and mobile control surface; UI validation/pseudo-stats explicitly separated from runtime evidence |
| CLR-0042 | **MASHETEVE V3 LHEA-HARDENED MVP** | Recovered later EVE descendant / Assessed | Very High governance relevance — MODULAR→CORE hardening, whole-integrity guard, Indus execution layer and Builder/Executor split; repetition must not be conflated with verified correctness |
